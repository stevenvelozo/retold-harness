module.exports = (
	{
		...
		"RetoldDataServiceOptions":
		{
			...
			"FullMeadowSchemaPath": `${__dirname}/bookstore/`,
		...
		"MSSQL":
			{
				...
				"database": process.env.MSSQL_DATABASE || "bookstore"
			},
		...
		"PostgreSQL":
			{
				...
				"Database": process.env.PGSQL_DATABASE || "bookstore",
				"ConnectionPoolLimit": 5
			},
		...
		"MongoDB":
			{
				...
				"Database": process.env.MONGODB_DATABASE || "bookstore"
			},
		...
		"Solr":
			{
				...
				"Core": process.env.SOLR_CORE || "bookstore",
				"Path": "/solr",
				"Secure": false
			}
	});